...
import com.dimadyuk.smackchat.utilities.Constants.URL_CREATE_USER
import com.dimadyuk.smackchat.utilities.Constants.URL_GET_USER
import com.dimadyuk.smackchat.utilities.Constants.URL_LOGIN
...
object AuthService {
    ...
    fun loginUser(
        ...
        val loginRequest = object : JsonObjectRequest(
            ...
            Response.ErrorListener { error ->
                Log.d("ERROR", "Could not receive auth token: $error")
                complete(false)
            }
        ) {
            override fun getBodyContentType(): String {
